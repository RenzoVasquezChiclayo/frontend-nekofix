  ...
  return (
    <section className="border-y border-zinc-200 bg-white py-16 sm:py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="overflow-hidden rounded-3xl bg-zinc-900 text-white shadow-xl shadow-zinc-900/10">
          <div className="grid md:grid-cols-2">
            <div className="relative p-8 sm:p-10 md:p-12">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_0%_0%,rgba(16,185,129,0.2),transparent_55%)]" />
              <div className="relative flex items-start gap-4">
                <span
                  className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-emerald-500 text-2xl"
                  aria-hidden
                >
                  🕒
                </span>
                <div>
                  <h2 className="text-lg font-semibold text-emerald-300/95">
                    {hours.title}
                  </h2>
