    ...
    <section className="relative overflow-hidden bg-primary-950 py-16 text-white sm:py-20">
      ...
      <div className="relative mx-auto max-w-6xl px-4 text-center sm:px-6">
        ...
        <a
          ...
          className="mt-8 inline-flex items-center justify-center gap-2 rounded-full bg-[#25D366] px-10 py-4 text-sm font-semibold text-white transition hover:bg-[#20bd5a]"
        >
